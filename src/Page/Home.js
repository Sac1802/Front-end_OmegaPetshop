                    ...
                    <div className="contenedor-navegacion">
                        <div className="contenido-navegacion contenedor">
                            ...
                            <div className="logo m-2">
                                ...
                                <Link to={'/login'} className="float-lg-right container_links">Iniciar Sesion</Link>
                                <Link to={'/register'}  className="float-lg-right col-2 container_links">Registrarse</Link>
                                </div>
                            </div>
                            </nav>
                        </div>
